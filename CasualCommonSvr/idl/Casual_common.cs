...
public class Common
{
	public const ZNet.PacketType request_lobby_list = (ZNet.PacketType)(0+0);

	public const ZNet.PacketType notify_lobby_list = (ZNet.PacketType)(0+1);
	...
	public const ZNet.PacketType room_lobby_joinroom = (ZNet.PacketType)(0+8);

	public const ZNet.PacketType room_lobby_outroom = (ZNet.PacketType)(0+9);
